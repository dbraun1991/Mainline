...
saved by convention into `local/`, a scratch directory that's fully
gitignored, README included (ADR-0017, ADR-0018),
...
| `local/README.md` | Where LLM agents (and humans) should save local/converted story files — a fully gitignored scratch directory, not itself tracked (ADR-0017, ADR-0018) |
